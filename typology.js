/* ============================================================
   ТИПОЛОГИЯ
   Все флажки пока используют assets/флажок1.png как заглушку.
   Когда появятся реальные изображения, достаточно заменить src
   у конкретного элемента в FLAG_DATA.
   ============================================================ */
...
/* ------------------------------------------------------------
   ФЛАЖКИ
   Сейчас 16 мест — столько же, сколько в макете.
   ------------------------------------------------------------ */
